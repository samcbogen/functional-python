# Functional Python [![](https://github.com/samcbogen/functional-python/workflows/tests/badge.svg)](https://github.com/samcbogen/functional-python/actions?query=workflow%3Atests)
