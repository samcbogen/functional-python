# Functional Python [![](https://github.com/mikeizbicki/functional-python/workflows/tests/badge.svg)](https://github.com/samcbogen/functional-python/actions?query=workflow%3Atests)
